...
{		
	...
	*/	
	public static function quickbooksms_oneoff_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function quickbooksms_authorize_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function quickbooksms_capture_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function quickbooksms_void_payment($params)
	{
	 ...
	 *
	*/	
	public static function quickbooksms_refund_payment($params)
	{
	 ...
	 *
	 */		
	public static function quickbooksms_recurring_payment($params)
	{
		$this->_api_method = 'CustomerCreditCardChargeRq';
	 ...
	 * @return	object
	 */		
	private static function _parse_response($xml)
	{	
