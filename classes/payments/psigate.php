...
{		
	...
	*/	
	public static function psigate_oneoff_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function psigate_authorize_payment($params)
	{
		$this->_api_method = 'Order';
		$this->_set_messenger_settings();		
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function psigate_capture_payment($params)
	{
		$this->_api_method = 'Order';
		$this->_set_messenger_settings();		
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function psigate_void_payment($params)
	{
		$this->_api_method = 'Order';
		$this->_set_messenger_settings();		
	...
	*/	
	public static function psigate_refund_payment($params)
	{
		$this->_api_method = 'Order';
		$this->_set_messenger_settings();		
