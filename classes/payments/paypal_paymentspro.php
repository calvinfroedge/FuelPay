...
{	
	...
	*/	
	public static function paypal_paymentspro_oneoff_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_reference_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_authorize_payment($params)
	{
		$this->_api_method = array('METHOD' => 'DoDirectPayment');
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_capture_payment($params)
	{
		$this->_api_method = array('METHOD' => 'DoDirectPayment');
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_void_payment($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_change_transaction_status($params)
	{
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_refund_payment($params)
	{
	 ...
	 * @return	void
	*/	
	private static function _build_oneoff_request($params, $payment_action)
	{	
		$payment_array = array(
	 ...
	 * @return	object	The response from the payment gateway
	*/	
	public static function paypal_paymentspro_get_transaction_details($params)
	{
	...
	*/	
	public static function paypal_paymentspro_search_transactions($params)
	{
	 ...
	 */		
	public static function paypal_paymentspro_recurring_payment($params)
	{
	 ...
	 * @return	object
	 */		
	public static function paypal_paymentspro_get_recurring_profile($params)
	{
	 ...
	 * @return	object
	 */		
	public static function paypal_paymentspro_suspend_recurring_profile($params)
	{
	 ...
	 * @return	object
	 */		
	public static function paypal_paymentspro_activate_recurring_profile($params)
	{
		$this->_api_method = array('METHOD'	=> 'ManageRecurringPaymentsProfileStatus');
	 ...
	 * @return	object
	 */		
	public static function paypal_paymentspro_cancel_recurring_profile($params)
	{
		$this->_api_method = array('METHOD'	=> 'ManageRecurringPaymentsProfileStatus');
	 ...
	 * @return	object
	 */		
	public static function paypal_paymentspro_recurring_bill_outstanding($params)
	{
	 ...
	 * @return	object
	 */		
	public static function paypal_paymentspro_update_recurring_profile($params)
	{
